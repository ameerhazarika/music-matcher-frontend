      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Find your perfect music match. Connect with people who share your
            musical soul through Spotify-powered compatibility.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            ...
            <p className="text-gray-300">
              We analyze your Spotify listening history to understand your
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            ...
            <p className="text-gray-300">
              Our algorithm finds people with compatible music taste for
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            ...
            <p className="text-gray-300">
              Join a community of music lovers and discover new artists
              together.
            </p>
          </div>
        </div>
        ...
        <p className="text-sm text-gray-400 mt-4">
          We'll access your Spotify listening history to create your music
          profile
        </p>
      </div>
    </div>
